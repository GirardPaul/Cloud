...
<table class="table w-75">
  <thead class="bg-thead white-text">
    <tr>
      <th scope="col">Nom <span class=' 
                warning-color' alt='' width='20' height='20' type='button' data-toggle='modal' data-target='#new-folder'> <i class="fas fa-folder-plus"> </i> </span> </th>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <form enctype="multipart/form-data" action="" id="form2" method="post">
    ...
    <input type="submit" name="submit" id="btn_rename" onclick="reload()" class="btn btn-primary" value="Renommer">
</form>
      </div>
    </div>
  </div>
...
if(isset($_POST['submit']) AND isset($_COOKIE['Name'])){
  ...
  rename('C:/wamp/www/Explorateur-de-fichiers/'.$old, $new);
